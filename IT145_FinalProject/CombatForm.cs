...
namespace IT145_FinalProject
{
    public partial class CombatForm : Form
    {
        ...
        public CombatForm()
        {
            ...
            int tempcharAllyCount = Character._characterList.Count;

            switch (tempcharAllyCount)
            {
                case 1:
                    Ally2Panel.Enabled = false;
                    Ally2HealthBox.Enabled = false;
                    Ally2AtkBox.Enabled = false;
                    Ally2IntBox.Enabled = false;
                    ...
                    Ally3Panel.Enabled = false;
                    Ally3HealthBox.Enabled = false;
                    Ally3AtkBox.Enabled = false;
                    Ally3IntBox.Enabled = false;
                    ...
                    Enemy2Panel.Enabled = false;
                    Enemy2HealthBox.Enabled = false;
                    Enemy2AtkBox.Enabled = false;
                    Enemy2IntBox.Enabled = false;

                    Enemy2Panel.Hide();
                    Enemy2HealthBox.Hide();
                    Enemy2AtkBox.Hide();
                    Enemy2IntBox.Hide();

                    Enemy3Panel.Enabled = false;
                    Enemy3HealthBox.Enabled = false;
                    Enemy3AtkBox.Enabled = false;
                    Enemy3IntBox.Enabled = false;

                    Enemy3Panel.Hide();
                    Enemy3HealthBox.Hide();
                    Enemy3AtkBox.Hide();
                    Enemy3IntBox.Hide();
                    break;
                case 2:
        ...
        {
            CombatAbilityPanel.Hide();
            Enemy1Indicator.Show();
            Enemy2Indicator.Show();
            Enemy3Indicator.Show();
        ...
        {
            Character._characterEnemyList.Clear();
            Character._characterList.Clear();
            this.Close();
        }
    }
}
